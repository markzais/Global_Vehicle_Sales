...
######################################################
# Create a table of the top 20 vehicle sales Worldwide by Type
######################################################
...
# Calculate the percentage of Sales for each by COCOM
...
# Calculate the percentage of Sales for each by Command & Type
